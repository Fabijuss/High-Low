...
## Technical details
### Platform
The program was created using an online IDE named repl.it. This IDE has a number of features which increases ease of use during the development process.
